...
# Securox - Cross-Platform monitoring tool

# -------------------------------

import logging  # for alerts functions
import os  # for directory handling and creation
import platform # detect and report information about operating system and hardware
...
def log_base_path ():
    ...
    if os.path.exists(desktop):
        return os.path.join(desktop, "Securox", "logs")
    else:
        return os.path.join(os.path.expanduser('~'), "Securox", "logs")
...
def filealerts(component_name):
    ...
    # Part Of the Path /Securox and /Securox/logs
